...
/***/ function(module, exports, __webpack_require__) {
	...
	function heb(el, opts) {
	    return new _index2.default(el, opts);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Heb = function () {
	    ...
	    _createClass(Heb, [{
	        key: 'draw',
	        value: function draw() {
	            var cluster = _d2.default.layout.cluster().size([360, this.opts.r]).sort(null).value(function (d) {
	                return d.size;
	            });
	        ...
	        value: function packageHierarchy(classes) {
	            ...
	            classes.forEach(function (d) {
	                map.children.push({ name: d.name, size: d.size, key: d.name.replace(/\./ig, '-') });
	            });
